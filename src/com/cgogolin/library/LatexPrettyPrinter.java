...
//        map.put("\\textbackslash ","\u005C"); // very strange error!!!
    ...
    {
            //Expand some commands to unify the LaTeX encoding
        ...
        if (string.contains("\\"))
        {
                //First try to do some smart replacements
            ...
            for ( String command : foundCommandsList ) {
                ...
                //Then try to cath the rest
            // if (string.contains("\\"))
            // for ( LinkedHashMap.Entry<String, String> entry : latexCommandMap.entrySet() ) {
            //     if (!string.contains("\\")) break; //All entries in this list contain a \ so we can abort if string does not contain a
        ...
        // if (string.contains("\\")) 
        // {
        //     string=string+" notcaught";
        //     for ( String command : foundCommandsList ) {
        //         string=string+" found:'"+command+"'";
        //     }
        // }
