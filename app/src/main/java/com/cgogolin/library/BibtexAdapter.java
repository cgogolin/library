...
public class BibtexAdapter extends BaseAdapter {
    ...
    public BibtexAdapter(InputStream inputStream) throws java.io.IOException {
        ...
        for (BibtexEntry entry : bibtexEntryList) { //populate groups hashmap
    ...
    public synchronized void filterAndSortInBackground(String filter, SortMode sortMode, String group) {
        ...
        applyFilterTask.execute(filter, sortMode, group);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (displayedBibtexEntryList == null || displayedBibtexEntryList.size() == 0) {
            ...
            setTextViewAppearance(convertView.findViewById(R.id.separator), separatorText);
            setTextViewAppearance(convertView.findViewById(R.id.bibtex_info), "");
            setTextViewAppearance(convertView.findViewById(R.id.bibtex_title), entry.getTitle());
    ...
    private void makeExtraInfoVisible(final int position, View v, final Context context, boolean animate) {
        final LinearLayout extraInfo = v.findViewById(R.id.LinearLayout02);
